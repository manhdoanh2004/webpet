      ...
      <section className="section-3">
        <div className="container">
          <div className="section-3__wrap">
            <img className="section-3__bg3" src={section3bg3} alt="" />
            <img className="section-3__bg1" src={section3bg1} alt="" />
            ...
            <img className="section-3__bg2" src={section3bg2} alt="" />
            <img className="section-3__bg4" src={section3bg4} alt="" />
          </div>
        </div>
      </section>
    </>
